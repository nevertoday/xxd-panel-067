...
```text
/xxd-panel-067 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，067 设计在下）
2. 左右对照（原图在左，067 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-067/<fresh-task>/
...
- `references/xxd-panel-067-prompt.zh-CN.md`
- `references/xxd-panel-067-prompt.en.md`
