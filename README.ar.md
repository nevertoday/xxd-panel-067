...
# 🦁 XXD Panel 067｜رسم الفكاهة اليومية
...
ما يؤثر فينا حقاً في كثير من الصور اليومية ليس «المشهد الكبير»، بل وضعية أو تفاعل أو لمحة فكاهة يصعب وصفها. قد يجعل التلوين الكامل هذه التفاصيل عادية، بينما تحجب كثرة الزخارف حميمية الملاحظة التي تبدو كأنها دُوّنت على عجل.

يلتزم **Panel 067** بلونين فقط من الحبر المرسوم يدوياً، الأحمر والأزرق، ويكثف الحركة والعلاقات الأساسية في صفحة من الملاحظات الشخصية. تحفظ الخطوط المائلة والعبارات العامية القصيرة والمساحات الواسعة من الورق الفاتح الدفء والفكاهة معاً، من دون تغليف الصورة في هيئة رسم عام ومكرر.

### استخدمه في هذه الحالات

- **عندما تريد تسجيل لحظة طريفة من الحياة العادية:** يجب أن تصبح الحركة والعلاقات بين الأشخاص والحيوانات والأشياء مركز الحكاية.
- **عندما تريد هوية واضحة بألوان قليلة جداً:** يؤسس الحبران الثابتان، الأحمر والأزرق، وحدة بصرية من دون توسيع الصورة إلى لوحة متعددة الألوان.
- **عندما يجب أن تبدو الكلمات ملاحظة لا إعلاناً:** تتجاوب الكلمات الصغيرة المكتوبة باليد والعبارات العامية أو المحاكيات الصوتية طبيعياً مع الحدود والفراغ.
...
> استخدم XXD Panel 067 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.
...
## تحقق سريع: هل XXD Panel 067 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | استخدم الحبر الأحمر والأزرق الثابت لتسجيل الملاحظات اليومية اللطيفة والمرحة |
| **السمات التي تُعرف من النظرة الأولى** | أحمر وأزرق ثابت · حبر مزدوج مرسوم يدويًا · ملاحظة خاصة · فكاهة طفولية · مساحة كبيرة من المساحة الفارغة |
...
باستخدام أحبار الرسم الثابتة باللونين الأحمر والأزرق فقط، فإنه يكثف لحظة يومية مسلية أو مؤثرة أو مجازية في مركز سردي واحد وبعض القرائن. الخط الساذج، وأجزاء المحادثة، وحقل الورق الشاحب الواسع يخلق ملاحظة خاصة دافئة وروح الدعابة.

```text
تحديد مركز السرد اليومي ← إزالة المشهد الكامل والمعلومات الزخرفية ← تبسيط المحيط والحركة والعلاقات بالحبر الأحمر والأزرق ← دع بعض الرموز وعلامات الاتجاه تدعم القصة ← إنشاء الحالة المزاجية من خلال مساحة واسعة من الورق الشاحب ← إضافة أجزاء محادثة أو مسموعة أو باقية
```

## السمات التي تميّز الأسلوب النهائي

- الأحمر والأزرق هما الحبران الأساسيان الثابتان؛ الصورة لا توسعها إلى لوحة متعددة الألوان.
- الخطوط دقيقة، ملتوية، مكسورة، أو أعيد رسمها، مع مبالغة متناسبة ساذجة ولكن علاقات دقيقة.
- لم يبق سوى مركز سردي واحد وعدد قليل من الرموز ذات المغزى أو آثار الفعل أو خطوط الاتجاه.
- الموضوع لا يملأ الحقل أبدًا؛ أرضية ورقية شبه بيضاء تحمل الهواء والفكاهة والحنان.
- الكلمات الصغيرة المكتوبة بخط اليد، أو عبارات المحادثة، أو الأصوات، أو جملة واحدة متبقية تعكس الخطوط العريضة، والسهام، والمساحة الفارغة.

توجد القيود الجمالية وقواعد الرفض فقط في [الموجّه الصيني الأصلي](references/original-prompt/zh-CN.md)، بينما يتولى الـ Skill ومهايئ التشغيل متغيرات التسليم فقط. [سير عمل Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-067-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 067. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-067 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-067 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-067 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-067 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 067 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-067 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-067`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-067-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-067-prompt.zh-CN.md)
...
| **[xxd-panel-067](https://github.com/nevertoday/xxd-panel-067)** | شكل أسود رئيسي · فراغ هائل · تلاشي هالف تون · تأمل زِنّي · شظايا فكر |
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–067) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
